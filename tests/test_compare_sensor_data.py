...
def compare_sensor_data(api_data, displacement_model, sensor_list):
    ...
    for sensor in sensor_list:
        ...
        virtual_data = displacement_model.problem.sensors.get(sensor, None).data[0][2]
...
def test_compare_sensor_data():
    ...
    model_path = '/home/esh.msh'
    model_parameters = {}
    dt_path = '/home/min_parameters.json'
    ...
    for sensor, real_data, virtual_data, difference in comparison_results:
        ...
        assert difference < 1e-5, f"Difference for sensor {sensor} is too high: {difference}"
